...
class PushMsg {
    ...
    public function sendRequest($biz_content) {
        $custom_send = new \Org\Alipay\aop\request\AlipayMobilePublicMessageCustomSendRequest ();
        $custom_send->setBizContent($biz_content);
        $AlipayPocket = new \Org\Alipay\AlipayPocket();
    ...
    public function sendMsgRequest($biz_content, $isMultiSend = FALSE) {
        ...
        $httprequest = new \Org\Alipay\HttpRequest();
